...
#BSP:modify lcm driver LDQHLJS-3 by baofu.zhang 20200420 start
BOOT_LOGO = hdplus1640
#BSP:modify lcm driver LDQHLJS-3 by baofu.zhang 20200420 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add custom macro by wanghanfeng 20200325 start
CUSTOM_BUILD_VERNO = CY-LD7J-H694-O
#BSP: add custom macro by wanghanfeng 20200325 end
...
TRAN_CAMERA_FAKE_STEREO_YUV_INDEX = 4
CUSTOM_HAL_IMGSENSOR = s5k3p9sx_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc02m1_mipi_raw ov02b10_mipi_raw gc6153_serial_yuv pblcs5k3p9sx_mipi_raw pblcgc803430fps_mipi_raw pblcgc803430fpsext2_mipi_raw pblcgc02m1b_mipi_raw pblcov02b1b_mipi_raw pblcgc02m1_mipi_raw pblcov02b10_mipi_raw pblcgc6153_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw ov02b1b_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR =  s5k3p9sx_mipi_raw
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc02m1_mipi_raw ov02b10_mipi_raw
CUSTOM_TRAN_HAL_MAIN4_IMGSENSOR = gc6153_serial_yuv
#ITD:modify by camera driver team end

#BSP: add LDQHLJS-8 by zhi.chen for 20200416 start
CUSTOM_HAL_MSENSORLIB = mmc5603_ld7
#BSP: add LDQHLJS-8 by zhi.chen for 20200416 end
...
#BSP: add LDQHLJS-8 by zhi.chen for 20200416 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3p9sx_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc02m1_mipi_raw ov02b10_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc02m1b_mipi_raw ov02b1b_mipi_raw
...
#TSD: modify LDQHLJS-2 by chaochao.he 20200420 start
CUSTOM_MODEM=ld7_h694_n1
#TSD: modify LDQHLJS-2 by chaochao.he 20200420 end
...
#BSP:modify audio bring up LDQHLJS-4 yong.guo 20200421 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up LDQHLJS-4 yong.guo 20200421 end
...
#ITD:add cam 3pty function by yu.wang 20200421 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by yu.wang 20200421 end
...
#[ITD] Modify DualCam By Jesse 191015 Start
MTK_CAM_STEREO_CAMERA_SUPPORT = yes
#[ITD] Modify DualCam By Jesse 191015 End
...
#SDD: modify KEQHLEYL-12 by ke.zhang 20200428 start
MTK_CTA_SET = no
#SDD: modify KEQHLEYL-12 by ke.zhang 20200428 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:modify for fast charger XLJLHLJY-5 by yongxian.wang 20200417 start
MTK_DUAL_CHARGER_SUPPORT = yes
#BSP:modify for fast charger XLJLHLJY-5 by yongxian.wang 20200417 end
...
#TSD:modify ld7 p1 LDQHLJS-7 by huijun.shen 20200609 start
MTK_FM_SHORT_ANTENNA_SUPPORT = yes
#TSD:modify ld7 p1 LDQHLJS-7 by huijun.shen 20200609 end
MTK_FM_SUPPORT = yes
...
#BSP:add KBBHLESQ-1 by hanfeng.wang 20191031 start
MTK_WAPI_SUPPORT = no
#BSP:add KBBHLESQ-1 by hanfeng.wang 20191031 end
...
#BSP: add custom macro by wanghanfeng 20200325 start
CUSTOM_TRAN_PROJECT=tran_ld7j
CUSTOM_TRAN_BOM=tran_ld7j_o1
MTK_BUILD_VERNO=LD7j-H694O-Q-AS-220927V180
TRAN_FINGERPRINT_BUILD_VERNO=220927V180
